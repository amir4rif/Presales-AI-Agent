...
values
  ...
  ('PROP-DELETE-PENDING', 'CASE-DELETE-PENDING', 1, 'Pending Co', 'Pending Deal', 100,
    '12000000-0000-0000-0000-000000000001', 'Draft Owner',
    '12000000-0000-0000-0000-000000000001', 'Draft Owner', 'Pending Review', '', '{"executive":"Pending content"}'::jsonb),
  ('PROP-DELETE-APPROVED', 'CASE-DELETE-APPROVED', 1, 'Approved Co', 'Approved Deal', 100,
    '12000000-0000-0000-0000-000000000001', 'Draft Owner',
    '12000000-0000-0000-0000-000000000001', 'Draft Owner', 'Approved', '', '{"executive":"Approved content"}'::jsonb),
  ...
  ('PROP-DELETE-HISTORY-V1', 'CASE-DELETE-HISTORY', 1, 'History Co', 'History Deal', 100,
    '12000000-0000-0000-0000-000000000001', 'Draft Owner',
    '12000000-0000-0000-0000-000000000001', 'Draft Owner', 'Approved', '', '{"executive":"History content"}'::jsonb),
